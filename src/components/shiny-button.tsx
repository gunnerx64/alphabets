...
export const ShinyButton = ({
  ...
  return (
    <Link
      href={href ?? "#"}
      className={cn(
        "group relative flex transform items-center justify-center gap-2 overflow-hidden whitespace-nowrap rounded-md border border-white bg-brand-600 px-8 text-base/7 font-medium text-white transition-all duration-300 hover:ring-2 hover:ring-brand-600 hover:ring-offset-2 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:border-brand-600",
        className,
      )}
      {...props}
    >
